...
class Model():
    ...
    @classmethod
    def from_pretrained(cls, path: str = "./apiserver/models/namesgramms.pt"):
        return cls(path)
    ...
    def text_recognition_in_boxes(self, image, results, save_image: bool) -> dict:
        ...
        for result in results:
            ...
            if save_image:
                result.save(filename=f'DetectedNameImage.jpg')
        return text_results
    ...
    def format_results(self, text_results) -> dict:
        ...
        for category, text_list in text_results.items():
            ...
            if category == 'name':
                formatted_results['name'] = ' '.join(text_list)
            elif category == 'gramms':
                formatted_results['gramms'] = ''.join(text_list)
